...
__heap_limit
                ...
                PRESERVE8
                THUMB
				EXTERN SeverIntHandler
				EXTERN Port0IntHandler
				EXTERN Port1IntHandler
				EXTERN Port2IntHandler
				EXTERN Port3IntHandler
				EXTERN Port4IntHandler
				EXTERN Port5IntHandler
				EXTERN Port6IntHandler
...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     SeverIntHandler             ;   5: UART0 Rx and Tx
                DCD     Port1IntHandler             ;   6: UART1 Rx and Tx
                ...
                DCD     Port2IntHandler             ;  33: UART2 Rx and Tx
                ...
                DCD     Port5IntHandler             ;  59: UART3 Rx and Tx
                DCD     Port6IntHandler             ;  60: UART4 Rx and Tx
                DCD     Port3IntHandler             ;  61: UART5 Rx and Tx
                DCD     Port0IntHandler             ;  62: UART6 Rx and Tx
                DCD     Port4IntHandler             ;  63: UART7 Rx and Tx
                DCD     0                         ;  64: Reserved
                DCD     0                         ;  65: Reserved
                DCD     0                         ;  66: Reserved
                DCD     0                         ;  67: Reserved
